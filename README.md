...
> **_NOTE:_** APT installation instructions will be provided here when available. This method will allow you to install the plugin using the package manager for easier updates and management.
